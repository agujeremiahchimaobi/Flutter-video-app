...
class PageThree extends StatelessWidget {
  const PageThree({Key? key, this.ontap}) : super(key: key);
    ...
    return Container(
      ...
      child: Column(
        children: [
          ...
          const Images(image: 'images/selfie3.jfif',),
          const Text(
            Strings.welcomeText,
          ...
          const Spacer(),
          GestureDetector(onTap: ontap,child: const OnboardingButton(text: 'Get started'))
        ],
      ),
    );
  }
